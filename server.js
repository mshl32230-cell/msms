...
import { isGlitch, isReplit, isGitHub } from "./core/var/modules/environments.get.js";
...
// تقديم الملفات الثابتة (index.html + mezo.mp4)
...
app.listen(PORT, () => {
  logger.custom(`Web server running on http://localhost:${PORT}`, "WEB");
});
